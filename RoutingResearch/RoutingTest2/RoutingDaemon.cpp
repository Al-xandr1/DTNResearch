...
#define LET_ONLY    1   // 1 - использовать только LET - LET_Threshold отключаетс€ (равен "бесконечности)
#define MFV_ONLY    2   // 2 - использоват только MFV - LET_Threshold не имеет смысла, не используетс€
